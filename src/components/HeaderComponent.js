        ...
        render(){
                return (
                        ...
                        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                                <ModalHeader>Login
                                <span className="fa fa-window-close ml-auto"></span>
                                </ModalHeader>
                                <ModalBody>
                                        <Form onSubmit={this.handleLogin}>
                                                <FormGroup>
                                                        <Label htmlFor="username">Username</Label>
                                                        <Input type="text" id="username" name="username" placeholder="someone@example.com" innerRef={(input) => this.username = input}/>
                                                </FormGroup>
                                                <FormGroup>
                                                ...
                                                <Button typ="submit" className="bg-primary">Login</Button>
                                        </Form>
                                </ModalBody>
                        </Modal>
                        </>
